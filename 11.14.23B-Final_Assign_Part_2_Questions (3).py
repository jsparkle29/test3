...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Stastistics Dashboard", 
    style = {'textAlign': 'center', 'color': '#503D36', 'font-size':24}),
    html.Div([#TASK 2.2: Add two dropdown menus
        html.Label("Select Statistics:"),
        dcc.Dropdown(
            id='dropdown-stastistics',
            options=[
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(children=Y_chart3),html.Div(chlidren=Y_chart4)],style={'display':'flex'})
                ]
